...
<body>
    ...
    <div class="container py-2">
        <div class="mx-0 my-4 overflow-hidden row justify-content-center justify-content-lg-between align-content-center"
            style="min-height: calc(100vh - 4rem);">
            <div class="my-auto col-12 col-sm-10 col-md-8 col-lg-5 col-xxl-4" data-aos="zoom-in"
                ...
                <div class="">
                    ...
                    <div>
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="mb-4">
                                <button type="submit" class="text-white btn btn-main w-100">
                                    Reset password
                                </button>
                            </div>
                        </form>
            ...
            <div class="d-none d-lg-block col-lg-7 min-vh-80" data-aos="fade-right" data-aos-duration="3000">
                <div class="h-100 position-relative">
                    <div class="rounded h-100 w-100 bg-size-cover position-absolute z-index-n3"
                        style="background: url(/template/assets/img/team/t4.jpg) center top;">
                    </div>

                    <div class="rounded h-100 w-100 bg-dark position-absolute" style="--bs-bg-opacity: 0.9;">
                        <div class="row h-100 justify-content-center align-items-center">
                            <div class="text-white col-11 col-xl-8">
                                ...
                                <div class="mb-3">
                                    Tigma has transformed our business. Efficient solutions, seamless integration,
                                    professional team. Highly recommend.
                                </div>

                                <div>
                                    <img src="/template/assets/img/small-team/st4.jpg" height="40" width="40"
                                        class="img-fluid rounded-circle" alt="small team">
                                    <span>
