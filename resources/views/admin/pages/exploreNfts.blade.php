    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container mx-auto px-4 py-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Explore NFTs</h2>
                        ...
                        <table class="min-w-full border border-gray-300">
                            <thead>
                                <tr class="bg-gray-100 text-gray-700 uppercase text-sm">
                                    ...
                                    {{-- <th class="px-4 py-2 border">Miniting </th> --}}
                                ...
                                @forelse($nfts as $index => $nft)
                                    <tr class="text-center border">
                                        ...
                                        <td class="px-4 py-2 border">
                                            <img src="{{ asset($nft->image) }}" alt="NFT Image"
                                                class="w-16 h-16 object-cover rounded-md">
                                        </td>
                                        <td class="px-4 py-2 border">{{ $nft->name }}</td>
                                        <td class="px-4 py-2 border">{{ number_format($nft->price, 2) }} ETH</td>
                                        <td class="px-4 py-2 border">{{ $nft->creator_name }}</td>
                                        <td class="px-4 py-2 border">
                                            {{$nft->category}}
                                        ...
                                        <td class="px-4 py-2 border">
                                            ...
                                            <a href="{{ route('admin.artNfts.edit', $nft->id) }}"
