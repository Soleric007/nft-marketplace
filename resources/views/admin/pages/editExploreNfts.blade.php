        ...
        <div class="page-content">
            <div class="container mx-auto px-4 py-6">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    <form action="{{ route('admin.artNfts.update', $nft->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="mb-4">
                            <label class="block text-gray-700 font-bold mb-2">Title</label>
                            <input type="text" name="name" value="{{ old('title', $nft->name) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="description" value="{{ old('title', $nft->description) }}"
                                class="w-full p-2 border rounded-lg">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 font-bold mb-2">Category</label>
                            <input type="text" name="category" value="{{ old('title', $nft->category) }}"
                                class="w-full p-2 border rounded-lg">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($nft->image)
                                <p class="mb-2">
                                    <img src="{{ asset($nft->image) }}" alt="NFT Image" class="h-20">
                                </p>
                            @endif
