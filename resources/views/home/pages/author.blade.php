...
<body>
    <div id="wrapper">
                        ...
                        <div class="de-flex sm-pt10">
                            <div class="de-flex-col">
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="{{ route('index') }}">
                                            <img alt="" src="/template/assets/images/logo-1.png" />
                                        </a>
                                    </div>
                                    <!-- logo close -->
                                </div>
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <div class="menu_side_area">
                                    <div class="de-login-menu">
                                        <a href="{{ route('create') }}" class="btn-main"><i class="fa fa-plus"></i><span>Create</span></a>
                                        ...
                                        <span id="de-click-menu-profile" class="de-menu-profile">
                                            <img src="/template/assets/images/author_single/author_thumbnail.jpg" class="img-fluid" alt="">
                                        </span>
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <!-- section begin -->
            <section id="profile_banner" aria-label="section" class="text-light" data-bgimage="url(/template/assets/images/author_single/author_banner.jpg) top">
                           ...
                           <div class="d_profile de-flex">
                                <div class="de-flex-col">
                                    <div class="profile_avatar">
                                        <img src="/template/assets/images/author_single/author_thumbnail.jpg" alt="">
                                                    ...
                                                    <div class="nft__item">
                                                        ...
                                                        <div class="nft__item_wrap">
                                                            ...
                                                            <a href="{{ route('item-details') }}">
                                                                <img src="/template/assets/images/author_single/porto-1.jpg" class="lazy nft__item_preview" alt="">
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="nft__item">
                                                        ...
                                                        <div class="nft__item_wrap">
                                                            ...
                                                            <a href="{{ route('item-details') }}">
                                                                <img src="/template/assets/images/author_single/porto-2.jpg" class="lazy nft__item_preview" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="nft__item_info">
                                                            <a href="{{ route('item-details') }}">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="nft__item">
                                                        ...
                                                        <div class="nft__item_wrap">
                                                            ...
                                                            <a href="{{ route('item-details') }}">
                                                                <img src="/template/assets/images/author_single/porto-3.jpg" class="lazy nft__item_preview" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="nft__item_info">
                                                            <a href="{{ route('item-details') }}">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="nft__item">
                                                        ...
                                                        <div class="nft__item_wrap">
                                                            ...
                                                            <a href="{{ route('item-details') }}">
                                                                <img src="/template/assets/images/author_single/porto-4.jpg" class="lazy nft__item_preview" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="nft__item_info">
                                                            <a href="{{ route('item-details') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="nft__item">
                                                    ...
                                                    <div class="nft__item_wrap">
                                                        <a href="{{ route('item-details') }}">
                                                            <img src="/template/assets/images/items/anim-4.webp" class="lazy nft__item_preview" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="nft__item_info">
                                                        <a href="{{ route('item-details') }}">
                                    ...
                                    <div class="nft__item_price">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="nft__item">
                                                    ...
                                                    <div class="nft__item_wrap">
                                                        <a href="{{ route('item-details') }}">
                                                            <img src="/template/assets/images/items/anim-2.webp" class="lazy nft__item_preview" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="nft__item_info">
                                                        <a href="{{ route('item-details') }}">
                                    ...
                                    <div class="nft__item_price">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="nft__item">
                                                    ...
                                                    <div class="nft__item_wrap">
                                                        <a href="{{ route('item-details') }}">
                                                            <img src="/template/assets/images/items/anim-1.webp" class="lazy nft__item_preview" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="nft__item_info">
                                                        <a href="{{ route('item-details') }}">
                                    ...
                                    <div class="nft__item_price">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="nft__item">
                                                    ...
                                                    <div class="nft__item_wrap">
                                                        <a href="{{ route('item-details') }}">
                                                            <img src="/template/assets/images/items/anim-5.webp" class="lazy nft__item_preview" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="nft__item_info">
                                                        <a href="{{ route('item-details') }}">
