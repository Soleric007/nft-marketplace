...
<x-home-layout>
    ...
    <div class="no-bottom no-top" id="content">
        ...
        <section id="profile_banner" aria-label="section" class="text-light"
            data-bgimage="url(/template/assets/images/author_single/author_banner.jpg) top">
                                ...
                                <div class="profile_avatar">
                                    ...
                                    <div class="profile_name">
                                        <h4>
                                            ...
                                            <span id="wallet"
                                                class="profile_wallet">DdzFFzCqrhshMSxb9oW3mRo4MJrQkusV3fGFSTwaiu4wPBqMryA9DYVJCkW9n7twCffG5f5wX2sSkoDXGiZB1HPa7K7f865Kk4LqnrME</span>
                                ...
                                <div class="tab-1">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                <div class="de_countdown" data-year="2025" data-month="5" data-day="16"
                                                    data-hour="8"></div>
                                                <div class="author_list_pp">
                                                    <a href="{{ route('author') }}">
                                                        <img class="lazy"
                                                            src="/template/assets/images/author/author-1.jpg" alt="">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                </div>
                                                <div class="nft__item_wrap">
                                                    <div class="nft__item_extra">
                                                        <div class="nft__item_buttons">
                                                            <button
                                                                onclick="location.href='{{ route('item-details') }}'">Buy
                                                                Now</button>
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/author_single/porto-1.jpg"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/author_single/porto-2.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                <div class="de_countdown" data-year="2025" data-month="5" data-day="14"
                                                    data-hour="8"></div>
                                                <div class="author_list_pp">
                                                    <a href="{{ route('author') }}">
                                                        <img class="lazy"
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/author_single/porto-3.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/author_single/porto-4.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/items/anim-4.webp"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="nft__item">
                                                ...
                                                <div class="author_list_pp">
                                                    <a href="{{ route('author') }}">
                                                        <img class="lazy"
                                                            src="/template/assets/images/author/author-2.jpg" alt="">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                </div>
                                                <div class="nft__item_wrap">
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/items/anim-2.webp"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="nft__item">
                                                <div class="author_list_pp">
                                                    <a href="{{ route('author') }}">
                                                        <img class="lazy"
                                                            src="/template/assets/images/author/author-3.jpg" alt="">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                </div>
                                                <div class="nft__item_wrap">
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/items/anim-1.webp"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="nft__item">
                                                ...
                                                <div class="author_list_pp">
                                                    <a href="{{ route('author') }}">
                                                        <img class="lazy"
                                                            src="/template/assets/images/author/author-4.jpg" alt="">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                </div>
                                                <div class="nft__item_wrap">
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/items/anim-5.webp"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
