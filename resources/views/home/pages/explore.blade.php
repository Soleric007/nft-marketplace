                ...
                <div class="container">
                    <div class="row wow fadeIn">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Monica Lucas">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        ...
                                        <img src="/template/assets/images/items/static-1.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Stacy Long">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-2.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Ida Chapman">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-3.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Fred Ryan">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-4.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Franklin Greer">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-4.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Mamie Barnett">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-2.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Nicholas Daniels">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-1.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Lori Hart">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-5.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="de_countdown" data-year="2025" data-month="5" data-day="16" data-hour="8"></div>
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Jimmy Wright">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-3.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Gayle Hicks">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-5.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="de_countdown" data-year="2025" data-month="5" data-day="16" data-hour="8"></div>
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Karla Sharp">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-6.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                <div class="author_list_pp">
                                    <a href="{{ route('author') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Claude Banks">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-7.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-6.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/anim-8.webp" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-7.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
                        ...
                        <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="nft__item">
                                ...
                                <div class="nft__item_wrap">
                                    ...
                                    <a href="{{ route('item-details') }}">
                                        <div class="d-placeholder"></div>
                                        <img src="/template/assets/images/items/static-8.jpg" class="nft__item_preview" alt="">
                                    </a>
                                </div>
                                <div class="nft__item_info">
                                    <a href="{{ route('item-details') }}">
