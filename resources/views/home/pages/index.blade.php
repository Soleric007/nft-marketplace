                                    ...
                                    <div class="nft__item s2">
                                        {{-- @if($nft->expires_at)
                                            <div class="de_countdown"
                                                data-year="{{ $nft->expires_at->format('Y') }}"
                                                data-month="{{ $nft->expires_at->format('m') }}"
                                                data-day="{{ $nft->expires_at->format('d') }}"
                                                data-hour="{{ $nft->expires_at->format('H') }}">
                                            </div>
                                        @endif --}}
                                        <div class="author_list_pp">
                                            <a href="#" data-bs-toggle="tooltip" title="Creator: {{ $nft->creator_name ?? 'Unknown' }}">
                                                <img class="lazy" src="{{ $nft->creator_image ?? '/default-avatar.jpg' }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </a>
                                        </div>
                                        <div class="nft__item_wrap">
                                            ...
                                            <a href="{{route('artnft.show', $nft->id)}}">
                                                ...
                                                <img src="{{ $nft->image }}" class="lazy nft__item_preview" alt="">
                                            </a>
                                        </div>
                                        <div class="nft__item_info">
                                            <a href="#"><h4>{{ $nft->name }}</h4></a>
