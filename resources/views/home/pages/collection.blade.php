...
<x-home-layout>
    ...
    <div class="no-bottom no-top" id="content">
        ...
        <section id="profile_banner" aria-label="section" class="text-light"
            data-bgimage="url(/template/assets/images/background/4.jpg) top">
                        ...
                        <div class="d_profile">
                            <div class="profile_avatar">
                                <div class="d_profile_img">
                                    <img src="/template/assets/images/author/author-1.jpg" alt="">
                                            ...
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/collections/coll-item-1.jpg"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/collections/coll-item-2.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/collections/coll-item-3.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <div class="nft__item">
                                                ...
                                                <div class="nft__item_wrap">
                                                    ...
                                                    <a href="{{ route('item-details') }}">
                                                        <img src="/template/assets/images/collections/coll-item-4.jpg"
                                                            class="lazy nft__item_preview" alt="">
                                                    </a>
                                                </div>
                                                <div class="nft__item_info">
