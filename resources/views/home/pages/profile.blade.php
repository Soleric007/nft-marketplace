                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form id="form-create-item" class="form-border" method="post" action="email.php.html">
                                    ...
                                    <div class="tab-1">
                                        <div class="row wow fadeIn">
                                            ...
                                            <div id="sidebar" class="col-lg-4">
                                                ...
                                                <img src="/template/assets/images/author_single/author_thumbnail.jpg" id="click_profile_img" class="d-profile-img-edit img-fluid" alt="">
                                                ...
                                                <img src="/template/assets/images/author_single/author_banner.jpg" id="click_banner_img" class="d-banner-img-edit img-fluid" alt="">
