                ...
                <div class="row g-5">
                    <div class="col-md-6 text-center">
                        <div class="nft-image-wrapper">
                            <img src="/template/assets/images/items/big-4.jpg"
                                class="image-autosize img-fluid img-rounded mb-sm-30" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="item_info">
                            Auctions ends in <div class="de_countdown" data-year="2025" data-month="5" data-day="16"
                                data-hour="8"></div>
                                    ...
                                    <div class="item_author">
                                        <div class="author_list_pp">
                                            <a href="{{ route('collection') }}">
                                                <img class="lazy"
                                                    src="/template/assets/images/collections/coll-thumbnail-1.jpg"
                                                    alt="">
                                                <i class="fa fa-check"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="de_tab tab_simple">
                                ...
                                <h6>Price</h6>
                                <div class="nft-item-price"><img src="/template/assets/images/misc/ethereum.svg"
