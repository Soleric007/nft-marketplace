                                    ...
                                    <div class="tab-1">
                                        <div class="row wow fadeIn">
                                            ...
                                            <div id="sidebar" class="col-lg-4">
                                                ...
                                                <img src="/template/assets/images/author_single/author_thumbnail.jpg"
                                                ...
                                                <img src="/template/assets/images/author_single/author_banner.jpg"
                                                    id="click_banner_img" class="d-banner-img-edit img-fluid" alt="">
                                        ...
                                        <div class="row wow fadeIn">
                                            <div class="col-md-6 mb-sm-20">
                                                ...
                                                <div class="switch-with-title s2">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <p class="p-info">When an item you made an offer on changes in
                                                        price.</p>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="switch-with-title s2">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <p class="p-info">When an offer you placed is exceeded by another
                                                        user.</p>
                                                </div>
